...
<img src="images/UART-to-RS232.png" height="350">
<img src="images/ExtensionConnectors.PNG" height="350">
...
We'll make use of a interrupt service routine for the particular USART device by including the ```AL_UART_RxCpltCallback```,  which is triggered by explicity registering repeatedly RX interrupt ```HAL_UART_Receive_IT()```.  
